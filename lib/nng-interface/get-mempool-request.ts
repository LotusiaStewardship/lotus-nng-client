...
export class GetMempoolRequest {
  ...
  static getRootAsGetMempoolRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetMempoolRequest,
  ): GetMempoolRequest {
    return (obj || new GetMempoolRequest()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsGetMempoolRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetMempoolRequest,
  ): GetMempoolRequest {
  ...
  static createGetMempoolRequest(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
