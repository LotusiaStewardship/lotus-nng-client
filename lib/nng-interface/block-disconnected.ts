...
export class BlockDisconnected {
  ...
  static getRootAsBlockDisconnected(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockDisconnected,
  ): BlockDisconnected {
    return (obj || new BlockDisconnected()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsBlockDisconnected(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockDisconnected,
  ): BlockDisconnected {
  ...
  static createBlockDisconnected(
    builder: flatbuffers.Builder,
    blockOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
