...
export class GetUndoSliceRequest {
  ...
  static getRootAsGetUndoSliceRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetUndoSliceRequest,
  ): GetUndoSliceRequest {
    return (obj || new GetUndoSliceRequest()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsGetUndoSliceRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetUndoSliceRequest,
  ): GetUndoSliceRequest {
  ...
  static createGetUndoSliceRequest(
    builder: flatbuffers.Builder,
    fileNum: number,
    undoPos: number,
    numBytes: number,
