...
export class BlockHeader {
  ...
  static getRootAsBlockHeader(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockHeader,
  ): BlockHeader {
    return (obj || new BlockHeader()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsBlockHeader(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockHeader,
  ): BlockHeader {
  ...
  static addPrevBlockHash(
    builder: flatbuffers.Builder,
    prevBlockHashOffset: flatbuffers.Offset,
  ) {
