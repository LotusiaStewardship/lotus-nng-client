...
export class GetBlockSliceRequest {
  ...
  static getRootAsGetBlockSliceRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetBlockSliceRequest,
  ): GetBlockSliceRequest {
    return (obj || new GetBlockSliceRequest()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsGetBlockSliceRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetBlockSliceRequest,
  ): GetBlockSliceRequest {
  ...
  static endGetBlockSliceRequest(
  ...
  static createGetBlockSliceRequest(
    builder: flatbuffers.Builder,
    fileNum: number,
    dataPos: number,
    numBytes: number,
