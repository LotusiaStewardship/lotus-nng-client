...
export class BlockMetadata {
  ...
  static getRootAsBlockMetadata(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockMetadata,
  ): BlockMetadata {
    return (obj || new BlockMetadata()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsBlockMetadata(
    bb: flatbuffers.ByteBuffer,
    obj?: BlockMetadata,
  ): BlockMetadata {
  ...
  static addFieldValue(
    builder: flatbuffers.Builder,
    fieldValueOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(1, fieldValueOffset, 0)
  }

  static createFieldValueVector(
    builder: flatbuffers.Builder,
