...
export function unionToBlockIdentifier(
  ...
  switch (BlockIdentifier[type]) {
    case 'NONE':
      return null
    case 'Height':
      return accessor(new BlockHeight())! as BlockHeight
    case 'Hash':
      return accessor(new BlockHash())! as BlockHash
    default:
      return null
  }
}
...
export function unionListToBlockIdentifier(
  ...
  switch (BlockIdentifier[type]) {
    case 'NONE':
      return null
    case 'Height':
      return accessor(index, new BlockHeight())! as BlockHeight
    case 'Hash':
      return accessor(index, new BlockHash())! as BlockHash
    default:
      return null
  }
}
