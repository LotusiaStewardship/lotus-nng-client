...
import {
  BlockIdentifier,
  unionToBlockIdentifier,
  unionListToBlockIdentifier,
} from '../nng-interface/block-identifier.js'
...
export class GetBlockRequest {
  ...
  static getRootAsGetBlockRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetBlockRequest,
  ): GetBlockRequest {
    return (obj || new GetBlockRequest()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    )
  }

  static getSizePrefixedRootAsGetBlockRequest(
    bb: flatbuffers.ByteBuffer,
    obj?: GetBlockRequest,
  ): GetBlockRequest {
  ...
  static addBlockId(
    builder: flatbuffers.Builder,
    blockIdOffset: flatbuffers.Offset,
  ) {
